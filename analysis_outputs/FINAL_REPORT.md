...
- **Bayesian Inference** increased by 10.9% from early to recent era
- **Natural Language Processing** decreased by 10.5% from early to recent era
- **Symbolic Ai Logic** decreased by 10.4% from early to recent era
- **Optimization Methods** increased by 8.0% from early to recent era
- **Planning Decision Making** decreased by 5.4% from early to recent era
- The field has been **diversifying** (Shannon entropy: 2.99 → 3.19)
...
2. **Text Cleaning**: Header/footer removal, OCR error correction
3. **Semantic Classification**: Revised keyword-based full-text classification into 14 AI/ML sub-domains
...
*Classification method: Revised keyword-based*

### 3.1 Sub-domain Distribution by Document

| Year | Document | Top Domain | % |
|------|----------|------------|---|
| 1983 | Machine Learning... | supervised learning | 20.9% |
| 1986 | Macine Learning... | supervised learning | 35.7% |
| 1995 | Artificial Intelligence A Mode... | planning decision making | 25.8% |
| 1997 | Machine... | supervised learning | 22.0% |
| 2002 | Artificial Intelligence... | planning decision making | 31.3% |
| 2006 | Bishop-Pattern-Recognition-and... | bayesian inference | 28.8% |
| 2010 | Artificial Intelligence A Mode... | planning decision making | 21.9% |
| 2012 | Machine Learning... | bayesian inference | 33.2% |
| 2014 | Artificial intelligence a mode... | planning decision making | 22.0% |
| 2014 | understanding-machine-learning... | supervised learning | 24.2% |
| 2022 | Artificial Intelligence A Mode... | planning decision making | 17.1% |
...
|------------|------------|-----------|
| Bayesian Inference | +10.9% | ↑ Increased |
| Natural Language Processing | -10.5% | ↓ Decreased |
| Symbolic Ai Logic | -10.4% | ↓ Decreased |
| Optimization Methods | +8.0% | ↑ Increased |
| Planning Decision Making | -5.4% | ↓ Decreased |
| Search Algorithms | -5.2% | ↓ Decreased |
| Supervised Learning | -4.4% | ↓ Decreased |
| Kernel Methods | +3.9% | ↑ Increased |
| Statistical Learning Theory | +3.7% | ↑ Increased |
| Neural Networks Deep Learning | +3.1% | ↑ Increased |

### 4.3 Statistical Trend Analysis

| Sub-domain | Trend | Slope | R² | Significant |
|------------|-------|-------|----|-----------  |
| Bayesian Inference | increasing | +0.312 | 0.131 | ✓ |
| Symbolic Ai Logic | decreasing | -0.295 | 0.287 | ✓ |
| Supervised Learning | decreasing | -0.293 | 0.132 | ✓ |
| Natural Language Processing | decreasing | -0.287 | 0.237 | ✓ |
| Optimization Methods | increasing | +0.203 | 0.179 | ✓ |
| Reinforcement Learning | increasing | +0.157 | 0.146 | ✓ |
| Search Algorithms | decreasing | -0.131 | 0.117 | ✓ |
| Probabilistic Graphical Models | increasing | +0.123 | 0.154 | ✓ |
| Kernel Methods | increasing | +0.106 | 0.167 | ✓ |
| Neural Networks Deep Learning | increasing | +0.105 | 0.100 | ✓ |
| Unsupervised Learning | decreasing | -0.096 | 0.051 | ✓ |
| Ensemble Methods | increasing | +0.065 | 0.390 | ✓ |
| Statistical Learning Theory | increasing | +0.024 | 0.002 | ✓ |
| Computer Vision | increasing | +0.009 | 0.010 | ✓ |
| Planning Decision Making | decreasing | -0.002 | 0.000 | ✓ |

### 4.4 Field Diversity Over Time

| Year | Shannon Entropy | Dominant Domain | Concentration |
|------|-----------------|-----------------|---------------|
| 1983 | 2.94 | supervised learning | 20.9% |
| 1986 | 2.82 | supervised learning | 35.7% |
| 1995 | 3.22 | planning decision making | 25.8% |
| 1997 | 3.12 | supervised learning | 22.0% |
| 2002 | 2.92 | planning decision making | 31.3% |
| 2006 | 2.82 | bayesian inference | 28.8% |
| 2010 | 3.47 | planning decision making | 21.9% |
| 2012 | 2.90 | bayesian inference | 33.2% |
| 2014 | 2.81 | supervised learning | 24.2% |
| 2022 | 3.57 | planning decision making | 17.1% |
...
*Report generated: 2026-01-19 12:54:49*